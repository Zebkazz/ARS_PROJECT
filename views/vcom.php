    ...
    <div class="inser">
        <form class="m.tb-40" action="#" method="POST" enctype="multipart/form-data">
            <div class="row r1">
                ...
                <input type="hidden" class="form-control form-control-sm" id="com_tipó" name="com_tipo" value="<?= isset($val) ? $val[0]['com_tipo'] : 'C'; ?>" />
                <div class="form-group col-md-6" id="go1">
                        <label for="com_nom">Nombre Cliente</label>
                        <input type="text" class="form-control form-control-sm" id="com_nom" name="com_nom" value="<?= isset($val) ? $val[0]['com_nom'] : ''; ?>" required />
                </div>
                <div class="form-group col-md-6" id="go1">
                        <label for="com_ndoc">Numero de documento</label>
                        <input type="number" class="form-control form-control-sm" id="com_ndoc" name="com_ndoc" value="<?= isset($val) ? $val[0]['com_ndoc'] : ''; ?>" required />
                </div>
                <div class="form-group col-md-6" id="go1">
                        <label for="com_tel">Telefono</label>
                        <input type="number" class="form-control form-control-sm" id="com_tel" name="com_tel" value="<?= isset($val) ? $val[0]['com_tel'] : ''; ?>" required />
                </div>
                <div class="form-group col-md-6" id="go1">
                        <label for="com_ema">Email</label>
                        <input type="text" class="form-control form-control-sm" id="com_ema" name="com_ema" value="<?= isset($val) ? $val[0]['com_ema'] : ''; ?>" required />
                </div>
                <div class="form-group col-md-6" id="go1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center;">
                        ...
                        <i class="fa-duotone fa-users opctabla" data-bs-toggle="modal" data-bs-target="#myModal<?=$dtA['com_id'];?>" style="z-index:1500;" title="Ver clientes"></i>
