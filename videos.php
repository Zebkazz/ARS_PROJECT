...
<title>Videos de apoyo - ARS </title>
    <?php 
...
<div class="circle"></div>
    <div>
        <h1>Explicacion de uso e interfaz del software  <a href='home.php?pg=<?=$pg;?>' class='visemp'><i class='fa-duotone fa-circle-xmark never_butt' style="color:#f00"></i></a></h1>
    </div>
    <div class="mhome">
    ...
    <div class=info>
        ...
        <div class="bot">
            <button type="button" onclick="window.location='home.php?pg=<?=$pg;?>';" >Volver
            </button>
        </div>
    </div>
</div>
